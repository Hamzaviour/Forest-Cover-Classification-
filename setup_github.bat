...
git commit -m "Initial commit: Forest Cover Classification System - ✨ Features: Professional Streamlit GUI with card-based layout, Random Forest/XGBoost/Decision Tree models, Interactive data exploration, Model comparison and performance analysis, Real-time prediction interface - Created by Hamza Younas | Elevvo Pathways"
